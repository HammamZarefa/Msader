                ...
                <div class="search-area">
                    <form action="{{ route('service.search') }}" method="get">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn-Msader w-100"><i class="fas fa-search"></i> @lang('Search')</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn-Msader btn2" data-bs-dismiss="modal">@lang('Close')</button>
                <a href="" type="submit" class="btn-Msader order-now">@lang('Order Now')</a>
            </div>
        </div>
    </div>
</div>
