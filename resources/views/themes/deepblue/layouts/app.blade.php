...
{{--                    </li>--}}
            ...
            @guest
                <span class="navbar-text ps-4 d-none d-sm-block">
                    <a href="{{route('login')}}">
                        <button class="btn-Msader">@lang('Login')</button>
                    </a>
                </span>
            @else
                <span class="navbar-text ps-4  d-md-block d-none ">
                    <a href="{{route('user.home')}}">
                        <button class="btn-Msader">@lang('Dashboard')</button>
                    </a>
                </span>

                <span class="navbar-text ps-4 d-md-none">
                    <a href="{{route('user.home')}}">
                        <button class="btn-Msader icon-width"><i class="fa fa-home"></i></button>
                    </a>
                </span>
...
@endif
    ...
    <script>
        ...
        root.style.setProperty('--violet', '{{config('basic.base_color')}}');
    </script>
</body>
</html>
