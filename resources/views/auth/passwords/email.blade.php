    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
        ...
        <div class="auth-box row">
            <div class="col-lg-7 col-md-5 modal-bg-img"
                 style="background-image: url({{url('assets/backend/images/big/3.jpg')}});">
            </div>
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="text-center">
                                    <button type="submit"
                                            class="btn btn-block btn-dark btn-sm">@lang('Send Password Reset Link')</button>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="text-center mt-5">
                                    <p>@lang("Don't have an account?") <a href="{{ route('register') }}"
                                                                          class="text-danger">@lang('Sign Up')</a></p>
                                </div>
                            </div>
                        </div>
                    </form>
