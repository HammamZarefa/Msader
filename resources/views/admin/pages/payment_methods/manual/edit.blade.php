@extends('Msader_Matrix_v2.0_-_Nulled_Social_Media_Marketing_Tool.codecanyon-34394810-Msader-matrix-social-media-marketing-tool.project.resources.views.admin.layouts.app')
@section('title')
    {{ trans($page_title) }}
@endsection
@section('content')
