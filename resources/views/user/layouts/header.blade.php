<header>
    <div class="menu-area">
        <div class="container">
            ...
            <div class="menu-wrap">
                <nav class="menu-nav">
                    <div class="logo d-flex d-md-none m-auto"><a href="{{route('home')}}"><img src="{{ getFile(config('location.logoIcon.path').'logo.png')}}" alt=""></a></div>
                    ...
                    <div class="navbar-wrap main-menu d-none d-lg-flex">
                        <ul class="navigation">
                            ...
                            <li class="active d-none d-lg-flex">
                                <a href="{{ route('user.home') }}" class="logo m-0"><img src="{{ getFile(config('location.logoIcon.path').'logo.png')}}" alt=""></a>
                            </li>
            ...
            <div class="mobile-menu">
                <nav class="menu-box">
                    ...
                    <div class="nav-logo"><a href="index.html"><img src="{{ getFile(config('location.logoIcon.path').'logo.png')}}" alt=""></a>
                    </div>
