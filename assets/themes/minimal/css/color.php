...
#Msadernavbar .nav-registration {
margin-left: 150px !important;
}
#Msadernavbar .nav-link.active{
color: <?php echo $primaryColor; ?>;
}
#Msadernavbar .nav-registration .nav-link {
position: relative;
padding: 11px 30px;
color: #232323;
font-size: 16px;
...
#Msadernavbar .nav-registration .nav-link span {
position: relative;
z-index: 1;
}
#Msadernavbar .nav-registration .nav-link::before {
content: '';
position: absolute;
top: 0;
left: 0;
...
#Msadernavbar .nav-registration .nav-link:hover,
#Msadernavbar .nav-registration .active.nav-link {
color: #ffffff;
}
#Msadernavbar .nav-registration .nav-link:hover::before,
#Msadernavbar .nav-registration .active.nav-link::before {
width: 100%;
-webkit-transition: width 0.35s ease-in-out;
-ms-transition: width 0.35s ease-in-out;
-moz-transition: width 0.35s ease-in-out;
...
----------------------------------------------------------------------*/
#page-banner.servicesMsader-page {
background-image: linear-gradient(180deg, rgba(32, 77, 204, 0.8) 50%, rgba(32, 77, 204, 0.8) 50%), url('../images/banner.jpg');
background-position: center center;
background-size: cover;
background-repeat: no-repeat;
